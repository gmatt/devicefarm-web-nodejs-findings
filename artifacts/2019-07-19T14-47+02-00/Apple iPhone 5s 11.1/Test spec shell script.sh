#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirF8QN9U
export DEVICEFARM_DEVICE_NAME=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchbScJO1.scratch/custom_screenshotg6aqbO
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryYyo93m
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchbScJO1.scratch/DerivedDatabNUmyh
export SCREENSHOT_PATH=/tmp/scratchbScJO1.scratch/custom_screenshotg6aqbO
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryoxM946
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchbScJO1.scratch/DerivedDatabNUmyh
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchbScJO1.scratch/test-packageMSNEdN
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchbScJO1.scratch/DerivedDataYiZY33
install()
{
echo ' '
