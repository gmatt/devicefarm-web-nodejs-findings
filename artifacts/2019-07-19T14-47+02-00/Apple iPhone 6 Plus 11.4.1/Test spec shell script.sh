#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diruZXTkQ
export DEVICEFARM_DEVICE_NAME=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchda0sU2.scratch/custom_screenshotRyLlqZ
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryGCBSN1
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchda0sU2.scratch/DerivedDataxM3gvC
export SCREENSHOT_PATH=/tmp/scratchda0sU2.scratch/custom_screenshotRyLlqZ
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorydqk5gE
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchda0sU2.scratch/DerivedDataxM3gvC
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchda0sU2.scratch/test-packageYnBpVb
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchda0sU2.scratch/DerivedDataIMjtxG
install()
{
echo ' '
