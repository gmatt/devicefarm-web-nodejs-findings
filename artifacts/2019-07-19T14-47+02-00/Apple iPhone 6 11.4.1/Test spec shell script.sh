#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirHKYV7O
export DEVICEFARM_DEVICE_NAME=47e0f49d5ba3acc5db1c1a69f0834e1e9332a148
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchEyyuKJ.scratch/custom_screenshotldEPES
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryCflmbp
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchEyyuKJ.scratch/DerivedDatalKyztT
export SCREENSHOT_PATH=/tmp/scratchEyyuKJ.scratch/custom_screenshotldEPES
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryGn7GZk
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchEyyuKJ.scratch/DerivedDatalKyztT
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=47e0f49d5ba3acc5db1c1a69f0834e1e9332a148
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchEyyuKJ.scratch/test-packageZEx1Iy
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchEyyuKJ.scratch/DerivedDataPklDNZ
install()
{
echo ' '
