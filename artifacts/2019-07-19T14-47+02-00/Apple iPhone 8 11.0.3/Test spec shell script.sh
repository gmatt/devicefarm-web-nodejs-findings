#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirqJUawv
export DEVICEFARM_DEVICE_NAME=b3f2e940be8f1db5f1f0c37f45baefc4e93befaf
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch9s6as5.scratch/custom_screenshotYrxgaj
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryRTMxKi
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch9s6as5.scratch/DerivedDataq8EPvX
export SCREENSHOT_PATH=/tmp/scratch9s6as5.scratch/custom_screenshotYrxgaj
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryZSeUjT
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch9s6as5.scratch/DerivedDataq8EPvX
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=b3f2e940be8f1db5f1f0c37f45baefc4e93befaf
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch9s6as5.scratch/test-packageW4qaup
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch9s6as5.scratch/DerivedDatanNoY4U
install()
{
echo ' '
