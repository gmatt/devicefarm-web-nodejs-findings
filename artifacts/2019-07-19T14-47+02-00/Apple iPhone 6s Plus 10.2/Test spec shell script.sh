#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirE2uc2k
export DEVICEFARM_DEVICE_NAME=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchuwWJel.scratch/custom_screenshotzI5F38
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorybsFzuo
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchuwWJel.scratch/DerivedDataOhkMNd
export SCREENSHOT_PATH=/tmp/scratchuwWJel.scratch/custom_screenshotzI5F38
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory3TvcG3
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchuwWJel.scratch/DerivedDataOhkMNd
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchuwWJel.scratch/test-package27PxKD
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchuwWJel.scratch/DerivedDataIZAa3v
install()
{
echo ' '
