#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir7K0KtL
export DEVICEFARM_DEVICE_NAME=f7bafe02a234fca1ffacfc3a68c61545d9b55e4f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchi7W8fn.scratch/custom_screenshot3ddhP7
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryBK2jir
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchi7W8fn.scratch/DerivedDatawCYlkz
export SCREENSHOT_PATH=/tmp/scratchi7W8fn.scratch/custom_screenshot3ddhP7
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryYvf8UY
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchi7W8fn.scratch/DerivedDatawCYlkz
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=f7bafe02a234fca1ffacfc3a68c61545d9b55e4f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchi7W8fn.scratch/test-packageL13Ev_
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchi7W8fn.scratch/DerivedDataugMifV
install()
{
echo ' '
