#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diryzTvcp
export DEVICEFARM_DEVICE_NAME=b58a456856fa496f48ad5e0171841b464f361934
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchRcRh_D.scratch/custom_screenshotZNvghX
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryV3QDp1
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchRcRh_D.scratch/DerivedDataToycZ9
export SCREENSHOT_PATH=/tmp/scratchRcRh_D.scratch/custom_screenshotZNvghX
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryzak6rd
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchRcRh_D.scratch/DerivedDataaAOm9p
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=b58a456856fa496f48ad5e0171841b464f361934
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchRcRh_D.scratch/test-packagetRQcFy
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchRcRh_D.scratch/DerivedDataToycZ9
install()
{
echo ' '
