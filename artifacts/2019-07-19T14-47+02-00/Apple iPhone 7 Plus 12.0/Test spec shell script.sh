#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir5uJo7z
export DEVICEFARM_DEVICE_NAME=471933e81a6b8e5f104dc9784eff817b516d6afc
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchgijVDx.scratch/custom_screenshotCG2M9l
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryJqNhzE
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchgijVDx.scratch/DerivedDatai4A0dc
export SCREENSHOT_PATH=/tmp/scratchgijVDx.scratch/custom_screenshotCG2M9l
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory7NFMys
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchgijVDx.scratch/DerivedDataREd1Zm
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=471933e81a6b8e5f104dc9784eff817b516d6afc
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchgijVDx.scratch/test-package6Oqp_P
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchgijVDx.scratch/DerivedDatai4A0dc
install()
{
echo ' '
