#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirDz6E6U
export DEVICEFARM_DEVICE_NAME=5ea6974487c6c26302d6348ba5583d8164bd0aa5
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchLQAEYh.scratch/custom_screenshotGjPBT1
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryApZPRq
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchLQAEYh.scratch/DerivedDataB5HeOs
export SCREENSHOT_PATH=/tmp/scratchLQAEYh.scratch/custom_screenshotGjPBT1
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorylFFBwT
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchLQAEYh.scratch/DerivedData5y3Whx
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=5ea6974487c6c26302d6348ba5583d8164bd0aa5
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchLQAEYh.scratch/test-packagetkXYOF
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchLQAEYh.scratch/DerivedDataB5HeOs
install()
{
echo ' '
