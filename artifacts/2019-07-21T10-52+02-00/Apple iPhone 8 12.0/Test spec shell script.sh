#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirkOoDZ5
export DEVICEFARM_DEVICE_NAME=9dc4a5338c8b6ffcb945dc3da2762e8653791f09
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch5gbKjT.scratch/custom_screenshotMx_rty
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorygCzbIi
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch5gbKjT.scratch/DerivedDataebjIa4
export SCREENSHOT_PATH=/tmp/scratch5gbKjT.scratch/custom_screenshotMx_rty
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryfdMfT4
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch5gbKjT.scratch/DerivedData72xagE
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=9dc4a5338c8b6ffcb945dc3da2762e8653791f09
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch5gbKjT.scratch/test-packageDdSQ_N
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch5gbKjT.scratch/DerivedDataebjIa4
install()
{
echo ' '
