#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirVIFS0f
export DEVICEFARM_DEVICE_NAME=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchLI3zKN.scratch/custom_screenshotz_UaDD
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorywLirjz
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchLI3zKN.scratch/DerivedDataAqJXGc
export SCREENSHOT_PATH=/tmp/scratchLI3zKN.scratch/custom_screenshotz_UaDD
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryKbKn82
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchLI3zKN.scratch/DerivedDataAqJXGc
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchLI3zKN.scratch/test-packagem7o_mj
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchLI3zKN.scratch/DerivedDatasOU7yu
install()
{
echo ' '
