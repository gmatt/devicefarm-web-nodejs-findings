#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirx6Vw7K
export DEVICEFARM_DEVICE_NAME=429f02c78f62c3beb5b0b80b42fc12d607d83a84
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchTjSwBu.scratch/custom_screenshoty82euS
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryQ6jgDn
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchTjSwBu.scratch/DerivedData14qert
export SCREENSHOT_PATH=/tmp/scratchTjSwBu.scratch/custom_screenshoty82euS
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory8UNN1r
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchTjSwBu.scratch/DerivedData14qert
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=429f02c78f62c3beb5b0b80b42fc12d607d83a84
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchTjSwBu.scratch/test-packagefD30vl
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchTjSwBu.scratch/DerivedDataTbhlAC
install()
{
echo ' '
