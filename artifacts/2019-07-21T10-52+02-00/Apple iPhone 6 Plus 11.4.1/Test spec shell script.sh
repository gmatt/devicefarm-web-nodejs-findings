#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir_CqRc1
export DEVICEFARM_DEVICE_NAME=d1ff8ab2918c11b35064068e3f95144a76d84462
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchf0ksg6.scratch/custom_screenshotU_Rl5y
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryREFpsa
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchf0ksg6.scratch/DerivedDataxLFRC9
export SCREENSHOT_PATH=/tmp/scratchf0ksg6.scratch/custom_screenshotU_Rl5y
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryI6PXSD
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchf0ksg6.scratch/DerivedDataxLFRC9
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=d1ff8ab2918c11b35064068e3f95144a76d84462
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchf0ksg6.scratch/test-packagehz5Jdn
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchf0ksg6.scratch/DerivedDataVLKN5H
install()
{
echo ' '
