#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirMxReAl
export DEVICEFARM_DEVICE_NAME=da831f1462f2c208ece08f90304dc420e2b189cf
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchb0n0ME.scratch/custom_screenshotT5O42o
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryHaaJoP
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchb0n0ME.scratch/DerivedDatajM51p5
export SCREENSHOT_PATH=/tmp/scratchb0n0ME.scratch/custom_screenshotT5O42o
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryibKuNG
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchb0n0ME.scratch/DerivedDatajM51p5
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=da831f1462f2c208ece08f90304dc420e2b189cf
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchb0n0ME.scratch/test-packageS0ccFh
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchb0n0ME.scratch/DerivedDatavuj60V
install()
{
echo ' '
