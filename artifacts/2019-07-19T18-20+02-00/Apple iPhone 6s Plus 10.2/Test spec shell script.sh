#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirwGogDZ
export DEVICEFARM_DEVICE_NAME=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchXT_wFF.scratch/custom_screenshot2kUIdO
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryiFu4ek
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchXT_wFF.scratch/DerivedData5gnxYM
export SCREENSHOT_PATH=/tmp/scratchXT_wFF.scratch/custom_screenshot2kUIdO
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryEnjxcY
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchXT_wFF.scratch/DerivedData5gnxYM
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchXT_wFF.scratch/test-packagerR7j9I
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchXT_wFF.scratch/DerivedData2WBDCh
install()
{
echo ' '
