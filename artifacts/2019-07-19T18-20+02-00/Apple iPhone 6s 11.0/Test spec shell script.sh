#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirP_hFFR
export DEVICEFARM_DEVICE_NAME=429f02c78f62c3beb5b0b80b42fc12d607d83a84
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchua6ogn.scratch/custom_screenshotzzKIah
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorywiTFVt
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchua6ogn.scratch/DerivedDataj2Qqta
export SCREENSHOT_PATH=/tmp/scratchua6ogn.scratch/custom_screenshotzzKIah
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryYTxz6B
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchua6ogn.scratch/DerivedDataj2Qqta
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=429f02c78f62c3beb5b0b80b42fc12d607d83a84
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchua6ogn.scratch/test-package4iL4EX
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchua6ogn.scratch/DerivedDataf7HK0p
install()
{
echo ' '
