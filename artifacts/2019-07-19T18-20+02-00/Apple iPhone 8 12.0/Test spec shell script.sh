#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirMr7Wek
export DEVICEFARM_DEVICE_NAME=9dc4a5338c8b6ffcb945dc3da2762e8653791f09
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch4hqz0t.scratch/custom_screenshotR1qAs5
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryeoyVFZ
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch4hqz0t.scratch/DerivedDataBNaVCa
export SCREENSHOT_PATH=/tmp/scratch4hqz0t.scratch/custom_screenshotR1qAs5
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryzYcfId
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch4hqz0t.scratch/DerivedDataGZkdpN
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=9dc4a5338c8b6ffcb945dc3da2762e8653791f09
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch4hqz0t.scratch/test-packagen3et0q
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch4hqz0t.scratch/DerivedDataBNaVCa
install()
{
echo ' '
