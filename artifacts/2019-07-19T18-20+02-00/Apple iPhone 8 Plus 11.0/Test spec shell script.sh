#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirsDjsSt
export DEVICEFARM_DEVICE_NAME=05c1db167b78af4f220d399b562327f0e4e1575f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchdz1_Xs.scratch/custom_screenshotXB5xV3
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory2_axVR
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchdz1_Xs.scratch/DerivedDataYXfSEB
export SCREENSHOT_PATH=/tmp/scratchdz1_Xs.scratch/custom_screenshotXB5xV3
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryxNkzUU
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchdz1_Xs.scratch/DerivedDataYXfSEB
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=05c1db167b78af4f220d399b562327f0e4e1575f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchdz1_Xs.scratch/test-packagerUNX_g
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchdz1_Xs.scratch/DerivedData6WBVaF
install()
{
echo ' '
