#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirfzeK63
export DEVICEFARM_DEVICE_NAME=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchotXmUD.scratch/custom_screenshoteBr1pp
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorycPNDYP
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchotXmUD.scratch/DerivedDatagHt36g
export SCREENSHOT_PATH=/tmp/scratchotXmUD.scratch/custom_screenshoteBr1pp
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryfCueJR
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchotXmUD.scratch/DerivedDatagHt36g
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchotXmUD.scratch/test-packageeb2Nq3
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchotXmUD.scratch/DerivedDatapjYonJ
install()
{
echo ' '
