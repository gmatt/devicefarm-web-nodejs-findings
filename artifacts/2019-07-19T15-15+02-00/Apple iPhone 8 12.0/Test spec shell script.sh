#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirni6vQd
export DEVICEFARM_DEVICE_NAME=b58a456856fa496f48ad5e0171841b464f361934
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch8WRqWy.scratch/custom_screenshotwGAD5S
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryxoZDVq
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch8WRqWy.scratch/DerivedDatarGa6hO
export SCREENSHOT_PATH=/tmp/scratch8WRqWy.scratch/custom_screenshotwGAD5S
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryTNxIBE
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch8WRqWy.scratch/DerivedDatatbVsqK
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=b58a456856fa496f48ad5e0171841b464f361934
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch8WRqWy.scratch/test-packagepT3FA0
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch8WRqWy.scratch/DerivedDatarGa6hO
install()
{
echo ' '
