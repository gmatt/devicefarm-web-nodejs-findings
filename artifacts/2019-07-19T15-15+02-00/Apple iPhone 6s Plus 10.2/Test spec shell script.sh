#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir7iwDsV
export DEVICEFARM_DEVICE_NAME=8b2e2b5ee3757ef1e9f2e5e844e4572409344b51
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchVMW1se.scratch/custom_screenshotuXu7fK
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryGWRVfL
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchVMW1se.scratch/DerivedDatahvNjfz
export SCREENSHOT_PATH=/tmp/scratchVMW1se.scratch/custom_screenshotuXu7fK
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryZXGz1S
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchVMW1se.scratch/DerivedDatahvNjfz
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8b2e2b5ee3757ef1e9f2e5e844e4572409344b51
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchVMW1se.scratch/test-packageDOcP4I
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchVMW1se.scratch/DerivedDatak4Mgt9
install()
{
echo ' '
