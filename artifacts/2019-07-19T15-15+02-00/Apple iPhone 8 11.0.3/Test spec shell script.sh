#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir1veQWi
export DEVICEFARM_DEVICE_NAME=086819b8603885c4fa6ad8ede353cfb5f152f025
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchcC2d49.scratch/custom_screenshot7gMHAM
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryHZSeFs
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchcC2d49.scratch/DerivedDataCLFleB
export SCREENSHOT_PATH=/tmp/scratchcC2d49.scratch/custom_screenshot7gMHAM
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryeQgBbP
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchcC2d49.scratch/DerivedDataCLFleB
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=086819b8603885c4fa6ad8ede353cfb5f152f025
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchcC2d49.scratch/test-packageW5ct6r
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchcC2d49.scratch/DerivedDataqfqNps
install()
{
echo ' '
