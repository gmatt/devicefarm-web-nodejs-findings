#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirpPylGJ
export DEVICEFARM_DEVICE_NAME=5d8a5c88d33738febf42877adc8ab44a9865be81
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchF_4NHf.scratch/custom_screenshotftho5Q
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryIM7YNP
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchF_4NHf.scratch/DerivedDataPeV4ip
export SCREENSHOT_PATH=/tmp/scratchF_4NHf.scratch/custom_screenshotftho5Q
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory3Rnqz6
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchF_4NHf.scratch/DerivedDataPeV4ip
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=5d8a5c88d33738febf42877adc8ab44a9865be81
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchF_4NHf.scratch/test-packageeRz2mY
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchF_4NHf.scratch/DerivedDatasnPmqb
install()
{
echo ' '
