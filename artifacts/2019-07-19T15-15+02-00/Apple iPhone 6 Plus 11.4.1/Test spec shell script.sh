#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirgeopoC
export DEVICEFARM_DEVICE_NAME=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchUKZdeo.scratch/custom_screenshotxbCKLT
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory61wk6x
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchUKZdeo.scratch/DerivedDatam2j32V
export SCREENSHOT_PATH=/tmp/scratchUKZdeo.scratch/custom_screenshotxbCKLT
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryjsotIs
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchUKZdeo.scratch/DerivedDatam2j32V
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchUKZdeo.scratch/test-package1io8dJ
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchUKZdeo.scratch/DerivedData0jo3_r
install()
{
echo ' '
