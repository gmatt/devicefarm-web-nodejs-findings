#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirBhQUL_
export DEVICEFARM_DEVICE_NAME=2c598f81d95e723265938302bd5bedbf8dfa67ac
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchb33_h0.scratch/custom_screenshotqPendH
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryVZOk89
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchb33_h0.scratch/DerivedDatafdMP4K
export SCREENSHOT_PATH=/tmp/scratchb33_h0.scratch/custom_screenshotqPendH
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryvH6syk
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchb33_h0.scratch/DerivedDatafdMP4K
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=2c598f81d95e723265938302bd5bedbf8dfa67ac
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchb33_h0.scratch/test-packagejoLM8E
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchb33_h0.scratch/DerivedData3Q5GGN
install()
{
echo ' '
