#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirBCpmKR
export DEVICEFARM_DEVICE_NAME=a7d1847acb42df68317a5b29688581978cab8fdd
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch0_hNRa.scratch/custom_screenshotWBwO9w
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryrPnHZs
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch0_hNRa.scratch/DerivedDataAQiX9j
export SCREENSHOT_PATH=/tmp/scratch0_hNRa.scratch/custom_screenshotWBwO9w
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryf3u_WC
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch0_hNRa.scratch/DerivedDatalUOJxO
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=a7d1847acb42df68317a5b29688581978cab8fdd
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch0_hNRa.scratch/test-packageJYh5fq
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch0_hNRa.scratch/DerivedDataAQiX9j
install()
{
echo ' '
