#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirQ98JR5
export DEVICEFARM_DEVICE_NAME=429f02c78f62c3beb5b0b80b42fc12d607d83a84
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchz7RJ7v.scratch/custom_screenshotFc0piK
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory6vC2eu
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchz7RJ7v.scratch/DerivedDataQXXXAQ
export SCREENSHOT_PATH=/tmp/scratchz7RJ7v.scratch/custom_screenshotFc0piK
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryDrnE0C
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchz7RJ7v.scratch/DerivedDataQXXXAQ
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=429f02c78f62c3beb5b0b80b42fc12d607d83a84
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchz7RJ7v.scratch/test-package19xv1z
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchz7RJ7v.scratch/DerivedDataAhpR0k
install()
{
echo ' '
