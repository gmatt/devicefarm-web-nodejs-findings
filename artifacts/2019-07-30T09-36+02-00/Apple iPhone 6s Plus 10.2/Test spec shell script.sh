#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir2f_9Nw
export DEVICEFARM_DEVICE_NAME=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchKcz3Yw.scratch/custom_screenshotlbKefk
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory7MImMI
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchKcz3Yw.scratch/DerivedDatapyVjHf
export SCREENSHOT_PATH=/tmp/scratchKcz3Yw.scratch/custom_screenshotlbKefk
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryEcOUb4
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchKcz3Yw.scratch/DerivedDatapyVjHf
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchKcz3Yw.scratch/test-packageX7_Ms6
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchKcz3Yw.scratch/DerivedDataVKAxnO
install()
{
echo ' '
