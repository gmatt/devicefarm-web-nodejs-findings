#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirCMxyaG
export DEVICEFARM_DEVICE_NAME=7674cfcd6aa3d4bbc774c88ba63ff1a8c334c90b
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchv03ovz.scratch/custom_screenshotVRpdxp
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryZ4u0KQ
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchv03ovz.scratch/DerivedDataGFVvm_
export SCREENSHOT_PATH=/tmp/scratchv03ovz.scratch/custom_screenshotVRpdxp
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryffWGvK
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchv03ovz.scratch/DerivedDatahvPMUS
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=7674cfcd6aa3d4bbc774c88ba63ff1a8c334c90b
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchv03ovz.scratch/test-packagebIgeI0
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchv03ovz.scratch/DerivedDataGFVvm_
install()
{
echo ' '
