#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir2G33__
export DEVICEFARM_DEVICE_NAME=8cac5a07e6b5300c6750d468f0f6f3639bc9aebb
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchntuysc.scratch/custom_screenshotBFy1XG
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorygyN_ff
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchntuysc.scratch/DerivedDataNlMb7v
export SCREENSHOT_PATH=/tmp/scratchntuysc.scratch/custom_screenshotBFy1XG
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryt1jL3N
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchntuysc.scratch/DerivedDataNlMb7v
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8cac5a07e6b5300c6750d468f0f6f3639bc9aebb
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchntuysc.scratch/test-packagegk5O7r
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchntuysc.scratch/DerivedDatanAo_O4
install()
{
echo ' '
