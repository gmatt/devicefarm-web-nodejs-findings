#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir4F5Nxp
export DEVICEFARM_DEVICE_NAME=f29381bfb92119ad65183cd31c7d17f279d35d8b
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchDjcyVr.scratch/custom_screenshotFMhgOl
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryIN0Stq
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchDjcyVr.scratch/DerivedDataEdqNn7
export SCREENSHOT_PATH=/tmp/scratchDjcyVr.scratch/custom_screenshotFMhgOl
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryCjaOc6
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchDjcyVr.scratch/DerivedDataefzW10
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=f29381bfb92119ad65183cd31c7d17f279d35d8b
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchDjcyVr.scratch/test-packagej_bDOC
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchDjcyVr.scratch/DerivedDataEdqNn7
install()
{
echo ' '
