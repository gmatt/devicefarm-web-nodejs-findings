#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirK7KhaX
export DEVICEFARM_DEVICE_NAME=f7bafe02a234fca1ffacfc3a68c61545d9b55e4f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchFUaWRL.scratch/custom_screenshotWonbc_
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory9sZRLR
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchFUaWRL.scratch/DerivedDatae5kL_6
export SCREENSHOT_PATH=/tmp/scratchFUaWRL.scratch/custom_screenshotWonbc_
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory60aHLY
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchFUaWRL.scratch/DerivedDatae5kL_6
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=f7bafe02a234fca1ffacfc3a68c61545d9b55e4f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchFUaWRL.scratch/test-packageZGlOoj
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchFUaWRL.scratch/DerivedDataospubF
install()
{
echo ' '
