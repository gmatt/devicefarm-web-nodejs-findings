#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirUxKWEr
export DEVICEFARM_DEVICE_NAME=25783f8333d18791b2f966c38714846eb7458236
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch2U4oIX.scratch/custom_screenshot0HC5Sz
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryJ5c6GV
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch2U4oIX.scratch/DerivedDataZfMwJY
export SCREENSHOT_PATH=/tmp/scratch2U4oIX.scratch/custom_screenshot0HC5Sz
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorypjrjnq
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch2U4oIX.scratch/DerivedDataZfMwJY
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=25783f8333d18791b2f966c38714846eb7458236
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch2U4oIX.scratch/test-package38ZD9V
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch2U4oIX.scratch/DerivedDataOj4oFl
install()
{
echo ' '
