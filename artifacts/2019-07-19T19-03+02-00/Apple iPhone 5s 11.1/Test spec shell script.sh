#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirDFaB5c
export DEVICEFARM_DEVICE_NAME=f1dc9b780841d3a46d88ecff86e1d17618e0188b
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchxOnSg1.scratch/custom_screenshot4oxvB3
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryElNft3
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchxOnSg1.scratch/DerivedDatanTZsw9
export SCREENSHOT_PATH=/tmp/scratchxOnSg1.scratch/custom_screenshot4oxvB3
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryax_drj
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchxOnSg1.scratch/DerivedDatanTZsw9
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=f1dc9b780841d3a46d88ecff86e1d17618e0188b
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchxOnSg1.scratch/test-packagebNCc2M
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchxOnSg1.scratch/DerivedDataPJSU2N
install()
{
echo ' '
