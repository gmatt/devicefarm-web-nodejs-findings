#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diryGWltT
export DEVICEFARM_DEVICE_NAME=5d8a5c88d33738febf42877adc8ab44a9865be81
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchlP34DH.scratch/custom_screenshotVBUbhs
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryxH1VxH
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchlP34DH.scratch/DerivedData8Pawcg
export SCREENSHOT_PATH=/tmp/scratchlP34DH.scratch/custom_screenshotVBUbhs
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorymmxy4Q
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchlP34DH.scratch/DerivedData8Pawcg
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=5d8a5c88d33738febf42877adc8ab44a9865be81
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchlP34DH.scratch/test-packagecx3UuW
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchlP34DH.scratch/DerivedDataMd8zBQ
install()
{
echo ' '
