#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirtKCo5r
export DEVICEFARM_DEVICE_NAME=8cac5a07e6b5300c6750d468f0f6f3639bc9aebb
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchtnN1ge.scratch/custom_screenshotX4QLTc
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory9eeD3A
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchtnN1ge.scratch/DerivedDatarQBEky
export SCREENSHOT_PATH=/tmp/scratchtnN1ge.scratch/custom_screenshotX4QLTc
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryf4NW7o
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchtnN1ge.scratch/DerivedDatarQBEky
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8cac5a07e6b5300c6750d468f0f6f3639bc9aebb
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchtnN1ge.scratch/test-packagexvhyb3
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchtnN1ge.scratch/DerivedData8bs_6O
install()
{
echo ' '
