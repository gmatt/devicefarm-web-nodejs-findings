#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diri3ZNUF
export DEVICEFARM_DEVICE_NAME=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchixrZBb.scratch/custom_screenshot_JZeKE
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryoQRlrV
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchixrZBb.scratch/DerivedDataL5JQls
export SCREENSHOT_PATH=/tmp/scratchixrZBb.scratch/custom_screenshot_JZeKE
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryGyGSuG
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchixrZBb.scratch/DerivedDataL5JQls
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchixrZBb.scratch/test-packageuHeUJh
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchixrZBb.scratch/DerivedData5hIRRk
install()
{
echo ' '
