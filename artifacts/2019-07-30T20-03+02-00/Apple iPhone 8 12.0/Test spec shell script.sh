#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir4l2Pty
export DEVICEFARM_DEVICE_NAME=7674cfcd6aa3d4bbc774c88ba63ff1a8c334c90b
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchEBcYWN.scratch/custom_screenshot40sGT6
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorymRh_Y3
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchEBcYWN.scratch/DerivedDataVcnfXH
export SCREENSHOT_PATH=/tmp/scratchEBcYWN.scratch/custom_screenshot40sGT6
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory1pkiAE
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchEBcYWN.scratch/DerivedDataUqLO5i
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=7674cfcd6aa3d4bbc774c88ba63ff1a8c334c90b
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchEBcYWN.scratch/test-packageGDyQur
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchEBcYWN.scratch/DerivedDataVcnfXH
install()
{
echo ' '
