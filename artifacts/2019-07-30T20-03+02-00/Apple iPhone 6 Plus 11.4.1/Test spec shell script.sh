#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir9OxyJH
export DEVICEFARM_DEVICE_NAME=d1ff8ab2918c11b35064068e3f95144a76d84462
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch7SwQiH.scratch/custom_screenshotfW6jSA
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory1du8cG
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch7SwQiH.scratch/DerivedDataHXjjhC
export SCREENSHOT_PATH=/tmp/scratch7SwQiH.scratch/custom_screenshotfW6jSA
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory8uRZXe
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch7SwQiH.scratch/DerivedDataHXjjhC
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=d1ff8ab2918c11b35064068e3f95144a76d84462
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch7SwQiH.scratch/test-packageggCAsn
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch7SwQiH.scratch/DerivedDatak00in7
install()
{
echo ' '
