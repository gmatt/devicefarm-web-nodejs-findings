#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diryuZSdp
export DEVICEFARM_DEVICE_NAME=25783f8333d18791b2f966c38714846eb7458236
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchhOfOMX.scratch/custom_screenshotS4Bifg
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryussHkc
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchhOfOMX.scratch/DerivedDataQMoGH2
export SCREENSHOT_PATH=/tmp/scratchhOfOMX.scratch/custom_screenshotS4Bifg
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryjSBgs0
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchhOfOMX.scratch/DerivedDataQMoGH2
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=25783f8333d18791b2f966c38714846eb7458236
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchhOfOMX.scratch/test-packagegygZS_
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchhOfOMX.scratch/DerivedDataB5ewLT
install()
{
echo ' '
