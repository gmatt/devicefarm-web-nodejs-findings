#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir6ZoMPM
export DEVICEFARM_DEVICE_NAME=3f125becfe44e148fe40d343eaabc3894f06419f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchrTNpjN.scratch/custom_screenshotbqmoxk
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryRu9_1S
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchrTNpjN.scratch/DerivedDataG2pkmt
export SCREENSHOT_PATH=/tmp/scratchrTNpjN.scratch/custom_screenshotbqmoxk
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryku_TSa
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchrTNpjN.scratch/DerivedDataDTkHbg
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=3f125becfe44e148fe40d343eaabc3894f06419f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchrTNpjN.scratch/test-packageKSi8V3
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchrTNpjN.scratch/DerivedDataG2pkmt
install()
{
echo ' '
