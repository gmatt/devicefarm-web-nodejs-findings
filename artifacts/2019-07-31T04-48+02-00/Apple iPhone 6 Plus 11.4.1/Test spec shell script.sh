#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diro8mvEK
export DEVICEFARM_DEVICE_NAME=d9c11d387aeedb6545925fc555196a2fae6e6cf0
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch4qPUfz.scratch/custom_screenshotk7SZXj
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory3JUpfo
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch4qPUfz.scratch/DerivedDataGUoISB
export SCREENSHOT_PATH=/tmp/scratch4qPUfz.scratch/custom_screenshotk7SZXj
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryHnW7P5
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch4qPUfz.scratch/DerivedDataGUoISB
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=d9c11d387aeedb6545925fc555196a2fae6e6cf0
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch4qPUfz.scratch/test-packageVWj7VV
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch4qPUfz.scratch/DerivedDatai88v19
install()
{
echo ' '
