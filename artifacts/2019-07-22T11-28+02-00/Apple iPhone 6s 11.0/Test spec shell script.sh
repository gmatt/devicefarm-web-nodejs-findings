#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirbFA2ja
export DEVICEFARM_DEVICE_NAME=e938cd77a4362fe60c7072788feefcd72206df4f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratcha8KKmQ.scratch/custom_screenshotRzxdys
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryxR_UAK
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratcha8KKmQ.scratch/DerivedDatauMrN2h
export SCREENSHOT_PATH=/tmp/scratcha8KKmQ.scratch/custom_screenshotRzxdys
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryobszUN
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratcha8KKmQ.scratch/DerivedDatauMrN2h
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=e938cd77a4362fe60c7072788feefcd72206df4f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratcha8KKmQ.scratch/test-packageXU101Q
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratcha8KKmQ.scratch/DerivedData71xyYK
install()
{
echo ' '
