#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirsuKsuw
export DEVICEFARM_DEVICE_NAME=9dc4a5338c8b6ffcb945dc3da2762e8653791f09
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchx5lYma.scratch/custom_screenshotHHT8zW
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryOEFaVf
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchx5lYma.scratch/DerivedDatafUS9YW
export SCREENSHOT_PATH=/tmp/scratchx5lYma.scratch/custom_screenshotHHT8zW
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryO72_LM
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchx5lYma.scratch/DerivedData7iBqK6
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=9dc4a5338c8b6ffcb945dc3da2762e8653791f09
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchx5lYma.scratch/test-packageFE_T70
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchx5lYma.scratch/DerivedDatafUS9YW
install()
{
echo ' '
