#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir9LUGVY
export DEVICEFARM_DEVICE_NAME=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchWkC0rr.scratch/custom_screenshotU75Uqy
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryTwAGe7
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchWkC0rr.scratch/DerivedDataKYQeyJ
export SCREENSHOT_PATH=/tmp/scratchWkC0rr.scratch/custom_screenshotU75Uqy
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryKOldtC
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchWkC0rr.scratch/DerivedDataKYQeyJ
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchWkC0rr.scratch/test-packagext5lK6
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchWkC0rr.scratch/DerivedData94EdkI
install()
{
echo ' '
