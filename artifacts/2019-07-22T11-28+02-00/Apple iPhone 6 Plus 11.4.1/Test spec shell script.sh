#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirVaVMsg
export DEVICEFARM_DEVICE_NAME=694413b437ba3503fd477a4688ca4acd89d41591
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchn4Na37.scratch/custom_screenshot6Eq0Bl
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryHBrvCI
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchn4Na37.scratch/DerivedData3t8H2A
export SCREENSHOT_PATH=/tmp/scratchn4Na37.scratch/custom_screenshot6Eq0Bl
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory1aCkLu
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchn4Na37.scratch/DerivedData3t8H2A
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=694413b437ba3503fd477a4688ca4acd89d41591
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchn4Na37.scratch/test-packageUVpDD4
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchn4Na37.scratch/DerivedDataC3as_y
install()
{
echo ' '
