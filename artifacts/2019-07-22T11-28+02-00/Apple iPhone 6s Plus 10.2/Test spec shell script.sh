#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirEldhfr
export DEVICEFARM_DEVICE_NAME=8b2e2b5ee3757ef1e9f2e5e844e4572409344b51
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchI1tzYd.scratch/custom_screenshotRb_aoB
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryZBUx5Y
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchI1tzYd.scratch/DerivedDataYeVdis
export SCREENSHOT_PATH=/tmp/scratchI1tzYd.scratch/custom_screenshotRb_aoB
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryB0k70b
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchI1tzYd.scratch/DerivedDataYeVdis
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8b2e2b5ee3757ef1e9f2e5e844e4572409344b51
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchI1tzYd.scratch/test-packagePhHilP
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchI1tzYd.scratch/DerivedDataVK_1st
install()
{
echo ' '
