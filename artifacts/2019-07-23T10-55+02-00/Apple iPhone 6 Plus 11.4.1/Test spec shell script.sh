#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirRCqcMw
export DEVICEFARM_DEVICE_NAME=fa4464290007fe65a656b1e7c05b9d89686738bd
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchCSsRg7.scratch/custom_screenshotf1llw5
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryzejGXJ
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchCSsRg7.scratch/DerivedDataKcxqYE
export SCREENSHOT_PATH=/tmp/scratchCSsRg7.scratch/custom_screenshotf1llw5
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryvggb1F
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchCSsRg7.scratch/DerivedDataKcxqYE
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=fa4464290007fe65a656b1e7c05b9d89686738bd
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchCSsRg7.scratch/test-packageJhltE3
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchCSsRg7.scratch/DerivedDatam7UwD_
install()
{
echo ' '
