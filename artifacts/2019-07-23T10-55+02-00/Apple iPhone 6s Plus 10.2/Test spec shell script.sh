#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirjzmde_
export DEVICEFARM_DEVICE_NAME=25783f8333d18791b2f966c38714846eb7458236
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchw5dpH8.scratch/custom_screenshot0jAj6J
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorymQrth2
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchw5dpH8.scratch/DerivedDatabrF5vE
export SCREENSHOT_PATH=/tmp/scratchw5dpH8.scratch/custom_screenshot0jAj6J
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryBfjdbZ
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchw5dpH8.scratch/DerivedDatabrF5vE
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=25783f8333d18791b2f966c38714846eb7458236
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchw5dpH8.scratch/test-packagewOE7N6
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchw5dpH8.scratch/DerivedDataYWdDrH
install()
{
echo ' '
