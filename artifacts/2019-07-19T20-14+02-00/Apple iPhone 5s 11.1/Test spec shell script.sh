#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirGYutxN
export DEVICEFARM_DEVICE_NAME=da831f1462f2c208ece08f90304dc420e2b189cf
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchVpAVQC.scratch/custom_screenshotSAFdcB
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryMY1bdu
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchVpAVQC.scratch/DerivedDataj1Yu9D
export SCREENSHOT_PATH=/tmp/scratchVpAVQC.scratch/custom_screenshotSAFdcB
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryi8FNMe
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchVpAVQC.scratch/DerivedDataj1Yu9D
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=da831f1462f2c208ece08f90304dc420e2b189cf
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchVpAVQC.scratch/test-packagemeh8p3
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchVpAVQC.scratch/DerivedDataGAjMGI
install()
{
echo ' '
