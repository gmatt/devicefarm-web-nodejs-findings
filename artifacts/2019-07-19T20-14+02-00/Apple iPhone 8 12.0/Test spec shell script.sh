#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirx77hOR
export DEVICEFARM_DEVICE_NAME=3f125becfe44e148fe40d343eaabc3894f06419f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchhZTDLj.scratch/custom_screenshotpvvVTi
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory60281I
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchhZTDLj.scratch/DerivedDatamRoNCv
export SCREENSHOT_PATH=/tmp/scratchhZTDLj.scratch/custom_screenshotpvvVTi
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryl1Gw8s
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchhZTDLj.scratch/DerivedDataRshClz
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=3f125becfe44e148fe40d343eaabc3894f06419f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchhZTDLj.scratch/test-packageyORhR5
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchhZTDLj.scratch/DerivedDatamRoNCv
install()
{
echo ' '
