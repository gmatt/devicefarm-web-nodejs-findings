#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir4xcI8p
export DEVICEFARM_DEVICE_NAME=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchjMyMkw.scratch/custom_screenshot8lRtq3
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryM5DK59
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchjMyMkw.scratch/DerivedDataI9Uvi2
export SCREENSHOT_PATH=/tmp/scratchjMyMkw.scratch/custom_screenshot8lRtq3
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory8zrE53
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchjMyMkw.scratch/DerivedDataI9Uvi2
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=cf14e440871349e713ff33fa020c6160349d8f58
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchjMyMkw.scratch/test-packagemIdW1r
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchjMyMkw.scratch/DerivedDatad3R0Bb
install()
{
echo ' '
