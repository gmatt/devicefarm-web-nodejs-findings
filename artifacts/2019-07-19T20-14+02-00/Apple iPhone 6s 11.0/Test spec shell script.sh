#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirsIU2Ab
export DEVICEFARM_DEVICE_NAME=e938cd77a4362fe60c7072788feefcd72206df4f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchJAuyNk.scratch/custom_screenshothHUZHm
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryKsgEYe
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchJAuyNk.scratch/DerivedDataz16on9
export SCREENSHOT_PATH=/tmp/scratchJAuyNk.scratch/custom_screenshothHUZHm
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryMVZuD2
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchJAuyNk.scratch/DerivedDataz16on9
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=e938cd77a4362fe60c7072788feefcd72206df4f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchJAuyNk.scratch/test-packageffp6fc
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchJAuyNk.scratch/DerivedDatabmCsLW
install()
{
echo ' '
