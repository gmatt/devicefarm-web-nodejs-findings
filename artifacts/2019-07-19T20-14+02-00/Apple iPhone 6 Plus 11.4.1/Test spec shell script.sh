#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir39ZUTv
export DEVICEFARM_DEVICE_NAME=d1ff8ab2918c11b35064068e3f95144a76d84462
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchYDuNMZ.scratch/custom_screenshot4YcBKS
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryqzQqxm
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchYDuNMZ.scratch/DerivedDataQTg_hf
export SCREENSHOT_PATH=/tmp/scratchYDuNMZ.scratch/custom_screenshot4YcBKS
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryQfUtqZ
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchYDuNMZ.scratch/DerivedDataQTg_hf
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=d1ff8ab2918c11b35064068e3f95144a76d84462
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchYDuNMZ.scratch/test-packageX4Z1Jv
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchYDuNMZ.scratch/DerivedDatapIuZ_d
install()
{
echo ' '
