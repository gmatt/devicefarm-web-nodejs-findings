#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirqnjTTb
export DEVICEFARM_DEVICE_NAME=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchcDwSY3.scratch/custom_screenshotBtt59b
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryRbV7g2
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchcDwSY3.scratch/DerivedDataFeNcaV
export SCREENSHOT_PATH=/tmp/scratchcDwSY3.scratch/custom_screenshotBtt59b
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryeIbOde
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchcDwSY3.scratch/DerivedDataFeNcaV
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchcDwSY3.scratch/test-package4IRXHU
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchcDwSY3.scratch/DerivedDataaQ2b7v
install()
{
echo ' '
