#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir8hB_Cx
export DEVICEFARM_DEVICE_NAME=2757d09d22a0f05529d5f95b59b937cfca0dc086
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchLZqUH9.scratch/custom_screenshotBhaq8T
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryXFjLid
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchLZqUH9.scratch/DerivedDataIRW6yw
export SCREENSHOT_PATH=/tmp/scratchLZqUH9.scratch/custom_screenshotBhaq8T
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryyjiOYJ
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchLZqUH9.scratch/DerivedDatamaEMbc
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=2757d09d22a0f05529d5f95b59b937cfca0dc086
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchLZqUH9.scratch/test-package19ioxx
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchLZqUH9.scratch/DerivedDataIRW6yw
install()
{
echo ' '
