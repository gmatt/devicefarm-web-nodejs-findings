#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diroakw7F
export DEVICEFARM_DEVICE_NAME=ed2c0a3c54b5d70dd959e3ad80ed994ae316497e
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch4m7Ru1.scratch/custom_screenshotX2idmt
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryqR1wsF
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch4m7Ru1.scratch/DerivedDataayvCSX
export SCREENSHOT_PATH=/tmp/scratch4m7Ru1.scratch/custom_screenshotX2idmt
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorybtQS0L
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch4m7Ru1.scratch/DerivedDataayvCSX
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=ed2c0a3c54b5d70dd959e3ad80ed994ae316497e
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch4m7Ru1.scratch/test-packageXqPCYz
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch4m7Ru1.scratch/DerivedDatavLQTU1
install()
{
echo ' '
