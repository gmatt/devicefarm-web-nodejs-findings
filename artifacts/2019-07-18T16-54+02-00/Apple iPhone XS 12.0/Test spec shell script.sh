#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirJSbY0B
export DEVICEFARM_DEVICE_NAME=00008020-001574D03CC2002E
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchjdc4SH.scratch/custom_screenshotZ2UiJN
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryJqDY9C
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchjdc4SH.scratch/DerivedDataA_Tqhz
export SCREENSHOT_PATH=/tmp/scratchjdc4SH.scratch/custom_screenshotZ2UiJN
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory3DxPrI
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchjdc4SH.scratch/DerivedDatacc3b86
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=00008020-001574D03CC2002E
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchjdc4SH.scratch/test-packageyNlVjZ
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchjdc4SH.scratch/DerivedDataA_Tqhz
install()
{
echo ' '
