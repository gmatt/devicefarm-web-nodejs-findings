#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dircBzMzW
export DEVICEFARM_DEVICE_NAME=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchG8hBHT.scratch/custom_screenshot3KSgtC
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory3lUeGj
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchG8hBHT.scratch/DerivedDatainbvce
export SCREENSHOT_PATH=/tmp/scratchG8hBHT.scratch/custom_screenshot3KSgtC
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorytSDcdc
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchG8hBHT.scratch/DerivedDatainbvce
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=2ec8dc549b6ded198435c4a83e20b5d382680dbf
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchG8hBHT.scratch/test-packageaO8y0b
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchG8hBHT.scratch/DerivedDataBxEdTo
install()
{
echo ' '
