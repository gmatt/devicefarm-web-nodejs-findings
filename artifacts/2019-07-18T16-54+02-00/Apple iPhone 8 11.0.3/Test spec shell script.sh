#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirTqjdiE
export DEVICEFARM_DEVICE_NAME=ab85b13e34529c5dee42588ff48f5756be74139f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchsDEYNt.scratch/custom_screenshotWbGOUQ
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryvPp6Pv
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchsDEYNt.scratch/DerivedDataICSQyu
export SCREENSHOT_PATH=/tmp/scratchsDEYNt.scratch/custom_screenshotWbGOUQ
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryJhVr_C
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchsDEYNt.scratch/DerivedDataICSQyu
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=ab85b13e34529c5dee42588ff48f5756be74139f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchsDEYNt.scratch/test-packageIpHZPK
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchsDEYNt.scratch/DerivedData1maFPu
install()
{
echo ' '
