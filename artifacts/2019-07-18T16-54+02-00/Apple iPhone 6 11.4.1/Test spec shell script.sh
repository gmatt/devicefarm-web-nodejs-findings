#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir546EZC
export DEVICEFARM_DEVICE_NAME=f2bc095e2337f1b739b3adddc49848991d834e17
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch2Iel7P.scratch/custom_screenshotigAqbq
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryhhKFcL
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch2Iel7P.scratch/DerivedDatasCL_iL
export SCREENSHOT_PATH=/tmp/scratch2Iel7P.scratch/custom_screenshotigAqbq
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorymHcfkS
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch2Iel7P.scratch/DerivedDatasCL_iL
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=f2bc095e2337f1b739b3adddc49848991d834e17
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch2Iel7P.scratch/test-packageSlTaVm
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch2Iel7P.scratch/DerivedDataykKQ99
install()
{
echo ' '
