#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirIIcVa7
export DEVICEFARM_DEVICE_NAME=ba2b99493aa5871a34e6edf600d244c2515004e9
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchY38ktS.scratch/custom_screenshotJEXqsl
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryZY5cvC
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchY38ktS.scratch/DerivedData7HjSK0
export SCREENSHOT_PATH=/tmp/scratchY38ktS.scratch/custom_screenshotJEXqsl
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryR1HAmF
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchY38ktS.scratch/DerivedDataC7fYMc
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=ba2b99493aa5871a34e6edf600d244c2515004e9
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchY38ktS.scratch/test-packageUkhTGM
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchY38ktS.scratch/DerivedData7HjSK0
install()
{
echo ' '
