#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirxl54lP
export DEVICEFARM_DEVICE_NAME=8b2e2b5ee3757ef1e9f2e5e844e4572409344b51
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchOz9Jbc.scratch/custom_screenshottIYDg7
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryTFR2Nf
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchOz9Jbc.scratch/DerivedDatakmHXRj
export SCREENSHOT_PATH=/tmp/scratchOz9Jbc.scratch/custom_screenshottIYDg7
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryU0k6OX
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchOz9Jbc.scratch/DerivedDatakmHXRj
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8b2e2b5ee3757ef1e9f2e5e844e4572409344b51
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchOz9Jbc.scratch/test-packageUQhy69
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchOz9Jbc.scratch/DerivedDataeuYc6L
install()
{
echo ' '
