#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirxaKHww
export DEVICEFARM_DEVICE_NAME=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch9aWsWA.scratch/custom_screenshotkao0bG
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryj_n_0j
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch9aWsWA.scratch/DerivedDataF7uXNY
export SCREENSHOT_PATH=/tmp/scratch9aWsWA.scratch/custom_screenshotkao0bG
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorym14N1M
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch9aWsWA.scratch/DerivedDataF7uXNY
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=8db9ef40a11719beb75d77df328e6a4efb5c016f
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch9aWsWA.scratch/test-packageJMHxVZ
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch9aWsWA.scratch/DerivedDataI4reRa
install()
{
echo ' '
