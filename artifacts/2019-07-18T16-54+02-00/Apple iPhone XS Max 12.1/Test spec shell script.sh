#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir8zUvuG
export DEVICEFARM_DEVICE_NAME=00008020-000D4D5C3A90003A
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchVLFWij.scratch/custom_screenshotVvL49K
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory14K9WR
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchVLFWij.scratch/DerivedData0CGbym
export SCREENSHOT_PATH=/tmp/scratchVLFWij.scratch/custom_screenshotVvL49K
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directorytWTx22
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchVLFWij.scratch/DerivedData8k0hlP
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=00008020-000D4D5C3A90003A
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchVLFWij.scratch/test-package94hSoQ
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchVLFWij.scratch/DerivedData0CGbym
install()
{
echo ' '
