#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dir1ba2EM
export DEVICEFARM_DEVICE_NAME=00008020-0015319A3E88002E
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch13M0_U.scratch/custom_screenshotYL027Q
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directorymnrhC8
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch13M0_U.scratch/DerivedDatao3uoRR
export SCREENSHOT_PATH=/tmp/scratch13M0_U.scratch/custom_screenshotYL027Q
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directory2jI5I8
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch13M0_U.scratch/DerivedDatahr4nEI
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=00008020-0015319A3E88002E
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch13M0_U.scratch/test-packageHo8c0i
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch13M0_U.scratch/DerivedDatao3uoRR
install()
{
echo ' '
