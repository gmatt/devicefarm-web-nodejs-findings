#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_dirXfJrEP
export DEVICEFARM_DEVICE_NAME=9f519aec355f0cbeffd30f682c4f4c0580d609ab
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratchnZGU0y.scratch/custom_screenshotNZzBQk
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directory8duXyA
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratchnZGU0y.scratch/DerivedDataCpZA7L
export SCREENSHOT_PATH=/tmp/scratchnZGU0y.scratch/custom_screenshotNZzBQk
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryWnj6FV
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratchnZGU0y.scratch/DerivedDataCpZA7L
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=9f519aec355f0cbeffd30f682c4f4c0580d609ab
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratchnZGU0y.scratch/test-packageoBlyVf
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratchnZGU0y.scratch/DerivedDataav1VMv
install()
{
echo ' '
