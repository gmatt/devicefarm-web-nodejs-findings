#!/bin/bash
export DEVICEFARM_WORKING_DIR=/tmp/working_diraFKhBY
export DEVICEFARM_DEVICE_NAME=f34415c8cf3251955d82457642fcde2d9b4cef82
export DEVICEFARM_SCREENSHOT_PATH=/tmp/scratch8VnOb8.scratch/custom_screenshoti6_fqU
export DEVICEFARM_DEVICE_PLATFORM_NAME=iOS
export DEVICEFARM_LOG_DIR=/tmp/customer_log_directoryuluqDb
export DEVICEFARM_WDA_DERIVED_DATA_PATH=/tmp/scratch8VnOb8.scratch/DerivedData710DIg
export SCREENSHOT_PATH=/tmp/scratch8VnOb8.scratch/custom_screenshoti6_fqU
export WORKING_DIRECTORY=/tmp/customer_artifacts_working_directoryyL9h72
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V0=/tmp/scratch8VnOb8.scratch/DerivedDataNpsNQs
export HOME=/Users/device-farm
export DEVICEFARM_DEVICE_UDID=f34415c8cf3251955d82457642fcde2d9b4cef82
export DEVICEFARM_TEST_PACKAGE_PATH=/tmp/scratch8VnOb8.scratch/test-package46IBOi
export DEVICEFARM_WDA_DERIVED_DATA_PATH_V1=/tmp/scratch8VnOb8.scratch/DerivedData710DIg
install()
{
echo ' '
